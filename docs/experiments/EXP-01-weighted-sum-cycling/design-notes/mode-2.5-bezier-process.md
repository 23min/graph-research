...
supersedes: (none)
superseded_by: (none yet — pivot to E-EVOLVE-v2 methodology, see ADR 0001)
---
...
(ADR 0001) is intended to replace with directed search rather than manual
tuning.
...
was visual noise. The pivot in ADR 0001 reframes this as a multi-
...
multi-objective methodology (ADR 0001) may subsume some of these.
...
- **Multi-objective fitness for bezier-specific quality**. Crossings,
  ...
  Composing them under a Pareto front (per ADR 0001) would let Mode 2.5
